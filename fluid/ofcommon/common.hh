...
public:
    ...
    ;
    virtual bool equals(const QueueProperty & other);
    virtual QueuePropRate* clone() {
        return new QueuePropRate(*this);
    }
    uint16_t rate() {
        return this->rate_;
    }
...
public:
    ...
    std::string hw_desc() {
        return this->hw_desc_;
    }
    std::string sw_desc() {
        return this->sw_desc_;
    }
    std::string serial_num() {
        return this->serial_num_;
    }
    std::string dp_desc() {
        return this->dp_desc_;
    }
    void mfr_desc(std::string mfr_desc) {
        this->mfr_desc_ = mfr_desc;
    }
    void hw_desc(std::string hw_desc) {
        this->hw_desc_ = hw_desc;
    }
    void sw_desc(std::string sw_desc) {
        this->sw_desc_ = sw_desc;
    }
    void serial_num(std::string serial_num) {
        this->serial_num_ = serial_num;
    }
    void dp_desc(std::string dp_desc) {
...
public:
    ...
    uint64_t lookup_count() {
        return this->lookup_count_;
    }
    uint64_t matched_count() {
        return this->matched_count_;
    }
    void table_id(uint8_t table_id) {
        this->table_id_ = table_id;
    }
...
public:
    ...
    uint64_t tx_packets() {
        return this->rx_tx_stats.tx_packets;
    }
    uint64_t rx_bytes() {
        return this->rx_tx_stats.rx_bytes;
    }
    uint64_t tx_bytes() {
        return this->rx_tx_stats.tx_bytes;
    }
    uint64_t rx_dropped() {
        return this->rx_tx_stats.rx_dropped;
    }
    uint64_t tx_dropped() {
        return this->rx_tx_stats.tx_dropped;
    }
    uint64_t rx_errors() {
        return this->err_stats.rx_errors;
    }
    uint64_t tx_errors() {
        return this->err_stats.tx_errors;
    }
    uint64_t rx_frame_err() {
        return this->err_stats.rx_frame_err;
    }
    uint64_t rx_over_err() {
        return this->err_stats.rx_over_err;
    }
    uint64_t rx_crc_err() {
        return this->err_stats.rx_crc_err;
    }
    uint64_t collisions() {
    ...
    void rx_bytes(uint64_t rx_bytes) {
        this->rx_tx_stats.rx_bytes = rx_bytes;
    }
    void tx_bytes(uint64_t tx_bytes) {
        this->rx_tx_stats.tx_bytes = tx_bytes;
    }
    ...
    void rx_errors(uint64_t rx_errors) {
        this->err_stats.rx_errors = rx_errors;
    }
    void tx_errors(uint64_t tx_errors) {
        this->err_stats.tx_errors = tx_errors;
    }
...
public:
    ...
    uint64_t tx_bytes() {
        return this->tx_bytes_;
    }
    uint64_t tx_packets() {
        return this->tx_packets_;
    }
    uint64_t tx_errors() {
        return this->tx_errors_;
    }
    void queue_id(uint32_t queue_id) {
        this->queue_id_ = queue_id;
    }
    void tx_bytes(uint64_t tx_bytes) {
        this->tx_bytes_ = tx_bytes;
    }
    void tx_packets(uint64_t tx_packets) {
        this->tx_packets_ = tx_packets;
    }
    void tx_errors(uint64_t tx_errors) {
        this->tx_errors_ = tx_errors;
    }
};
