#ifndef OPENFLOW_OPENFLOW15_H
#define OPENFLOW_OPENFLOW15_H 1
 ...
 */
//#define OFP_VERSION   0x06 //Aman
const uint8_t OFP_VERSION = 0x06;

//#define OFP_MAX_TABLE_NAME_LEN 32 // Aman
...
//#define OFP_DEFAULT_MISS_SEND_LEN   128 //Aman
...
const uint8_t OFP_OXM_HEADER_LEN = 4;
const uint8_t OFP_OXM_IN_PORT_LEN = 4;
const uint8_t OFP_OXM_IN_PHY_PORT_LEN = 4;
const uint8_t OFP_OXM_ACTSET_OUTPUT_LEN = 4;
const uint8_t OFP_OXM_METADATA_LEN = 8;
const uint8_t OFP_OXM_ETH_TYPE_LEN = 2;
const uint8_t OFP_OXM_VLAN_VID_LEN = 2;
const uint8_t OFP_OXM_VLAN_PCP_LEN = 1;
const uint8_t OFP_OXM_IP_DSCP_LEN = 1;
...
const uint8_t OFP_OXM_ICMP_CODE_LEN = 1;
const uint8_t OFP_OXM_IPV6_LEN = 16;
const uint8_t OFP_OXM_IPV6_FLABEL_LEN = 4;
const uint8_t OFP_OXM_MPLS_TC_LEN = 1;
const uint8_t OFP_OXM_MPLS_LABEL_LEN = 4;
const uint8_t OFP_OXM_MPLS_BOS_LEN = 1;
const uint8_t OFP_OXM_IPV6_PBB_ISID_LEN = 4;
const uint8_t OFP_OXM_TUNNEL_ID_LEN = 8;
const uint8_t OFP_OXM_IPV6_EXTHDR_LEN = 2;
const uint8_t OFP_OXM_PACKET_REG_LEN = 8;
const uint8_t OFP_OXM_PACKET_TYPE_LEN = 4;

const uint8_t OFP_OXS_DURATION_LEN = 8;
const uint8_t OFP_OXS_IDLE_TIME_LEN = 8;
const uint8_t OFP_OXS_FLOW_COUNT_LEN = 4;
const uint8_t OFP_OXS_PACKET_COUNT_LEN = 8;
const uint8_t OFP_OXS_BYTE_COUNT_LEN = 8;
 ...
 * Switch implement a variable number of registers, may be 0.
 *
 * Prereqs: None.
 *
 * Format: 64-bit integer in network byte order.
 ...
 * Masking: Arbitrary masks.
 */
#define OXM_OF_PKT_REG(N)    (OXM_HEADER  (0x8001, N, 8))
#define OXM_OF_PKT_REG_W(N)  (OXM_HEADER_W(0x8001, N, 8))
...
struct ofp_instruction_header {
    ...
    uint8_t pad[4];               /* Pad to 64 bits. */ //Aman
};
OFP_ASSERT(sizeof(struct ofp_instruction_header) == 8); //Aman
 ...
 * is permanent. */
//#define OFP_FLOW_PERMANENT 0 // Aman

/* By default, choose a priority in the middle. */
//#define OFP_DEFAULT_PRIORITY 0x8000 // Aman
...
#define OFPQ_ALL      0xffffffff // Aman

/* Min rate > 1000 means not configured. */
//#define OFPQ_MIN_RATE_UNCFG      0xffff // Aman

/* Max rate > 1000 means not configured. */
//#define OFPQ_MAX_RATE_UNCFG      0xffff // Aman
